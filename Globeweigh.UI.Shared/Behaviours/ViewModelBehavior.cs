...
namespace Globeweigh.UI.Shared
{
    ...
    public static class ViewModelBehavior
    {
        ...
        /// </summary>
        public static readonly DependencyProperty LoadUnloadProperty =DependencyProperty.RegisterAttached("LoadUnload", typeof(Boolean),typeof(ViewModelBehavior),new FrameworkPropertyMetadata(false,new PropertyChangedCallback(OnLoadUnloadChanged)));
