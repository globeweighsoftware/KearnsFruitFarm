...
namespace WpfKb.Controls
{
    ...
    public class OnScreenKey : Border
    {
        ...
        public static readonly DependencyProperty KeyFontSizeProperty = DependencyProperty.Register("KeyFontSize", typeof(double), typeof(OnScreenKey), new UIPropertyMetadata(18.0, OnKeyFontSizePropertyChanged));
        ...
        private readonly SolidColorBrush _keySurfaceBrush = new SolidColorBrush(Color.FromRgb(56, 56, 56));
        ...
        private readonly SolidColorBrush _keySurfaceBorderBrush = new SolidColorBrush(Colors.Black);
        ...
        private static void OnKeyFontSizePropertyChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e)
        {
//            var keyboard = (OnScreenWebKeyboard)d;
//            keyboard._allOnScreenKeys.ToList().ForEach(x => x.KeyFontSize = (double)e.NewValue);
            ((OnScreenKey)sender)._keyText.FontSize = ((double)e.NewValue) ;
        }
