...
{
    public class PagingSourcesBehavior : Behavior<DataPager>
    {
        public static readonly DependencyProperty ActualSourceProperty =
            DependencyProperty.Register("ActualSource", typeof(object), typeof(PagingSourcesBehavior), null);
        public static readonly DependencyProperty SourcesProperty =
            DependencyProperty.Register("Sources", typeof(IList), typeof(PagingSourcesBehavior),
            new PropertyMetadata(null, (d, e) => ((PagingSourcesBehavior)d).OnSourcesChanged((IList)e.NewValue)));
